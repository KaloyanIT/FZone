...
class FavoritesTableViewController: UITableViewController, FoodSQLDataDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tableView.register(UITableViewCell.self, forCellReuseIdentifier: "sql-food-cell")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "sql-food-cell", for: indexPath)

        cell.textLabel?.text = foods?[indexPath.count].name
        return cell
    }
